              ...
              <div className="mb-6">
                {error ? (
                  ...
                  <p className="text-gray-600">
                    Found {totalPosts} result{totalPosts !== 1 ? 's' : ''} for &ldquo;{searchQuery}&rdquo;
                    {totalPages > 1 && (
                      <span className="ml-2">
              ...
              {!error && (
                <>
                  {posts.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      <p className="text-gray-500 text-lg mb-4">No results found for &ldquo;{searchQuery}&rdquo;</p>
